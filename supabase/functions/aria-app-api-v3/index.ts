...
async function liveAssistantContext(userId:string) {
  ...
  const activeRank=(m:any)=>{const s=String(m?.status||"");if(s==="running"&&hasLiveLease(m))return 60;return s==="running"?50:s==="waiting"&&hasLiveLease(m)?45:s==="waiting"?40:s==="planning"?30:s==="paused"?20:s==="queued"?10:0;};
