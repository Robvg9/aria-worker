...
Deno.serve(async req => {
  ...
  if (req.method === "GET" && u.pathname === `/.well-known/oauth-protected-resource/functions/v1/aria-mcp-server-grok-v2`) return reply(200, { resource: RESOURCE, authorization_servers: [AUTH_SERVER], bearer_methods_supported: ["header"], transport: TRANSPORT }, { "access-control-allow-origin": "*" });
