...
CREATE INDEX IF NOT EXISTS mission_events_mission_idx ON aria_internal.mission_events(mission_id, event_id DESC);
...
REVOKE ALL ON aria_internal.mission_state FROM anon, authenticated, PUBLIC;
REVOKE ALL ON aria_internal.mission_steps FROM anon, authenticated, PUBLIC;
REVOKE ALL ON aria_internal.mission_events FROM anon, authenticated, PUBLIC;
GRANT ALL ON aria_internal.mission_state TO service_role;
GRANT ALL ON aria_internal.mission_steps TO service_role;
GRANT ALL ON aria_internal.mission_events TO service_role;
GRANT USAGE, SELECT ON SEQUENCE aria_internal.mission_events_event_id_seq TO service_role;
