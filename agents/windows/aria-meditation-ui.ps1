...
$form.Text='ARIA — Meditación IA';$form.StartPosition='CenterScreen';$form.Size=New-Object System.Drawing.Size(560,410);$form.MinimumSize=New-Object System.Drawing.Size(560,410)
...
$goal=New-Object System.Windows.Forms.Label;$goal.AutoSize=$false;$goal.Size=New-Object System.Drawing.Size(490,65);$goal.Location=New-Object System.Drawing.Point(28,95);$form.Controls.Add($goal)
$log=New-Object System.Windows.Forms.TextBox;$log.Multiline=$true;$log.ReadOnly=$true;$log.ScrollBars='Vertical';$log.Location=New-Object System.Drawing.Point(28,165);$log.Size=New-Object System.Drawing.Size(490,125);$form.Controls.Add($log)
$items=@(@{t='INICIAR';x=28;p='/start'},@{t='PAUSAR';x=150;p='/pause'},@{t='AVANZA';x=272;p='/resume'},@{t='CERRAR';x=394;p='/stop'})
foreach($i in $items){$b=New-Object System.Windows.Forms.Button;$b.Text=$i.t;$b.Size=New-Object System.Drawing.Size(105,40);$b.Location=New-Object System.Drawing.Point($i.x,305);$p=$i.p;$b.Add_Click({Invoke-Aria $p;Refresh-Ui});$form.Controls.Add($b)}
