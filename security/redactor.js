...
function redact(value){const text=typeof value==='string'?value:JSON.stringify(value??'');let out=text;for(const re of PATTERNS)out=out.replace(re,'[REDACTED]');return out;}
