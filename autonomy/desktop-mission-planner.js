...
function createDesktopMissionPlanner({ device_id = DEFAULT_DEVICE_ID, max_steps = 12 } = {}) {
  ...
  function plan({ goal, constraints = {} } = {}) {
    ...
    return Object.freeze({ status: 'planned', version: VERSION, mission_type: 'desktop', goal: desktop.goal, strategy: desktop.strategy, target: Object.freeze({ type: 'device', device_id }), constraints: desktop.constraints, steps: Object.freeze(steps) });
  }
