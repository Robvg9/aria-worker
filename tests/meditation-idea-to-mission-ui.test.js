...
for(const marker of ['IDEA → MISIÓN','ANALIZAR Y PROPONER','ACTUALIZAR PROPUESTAS','NO AUTOENCOLADA','autoencolado','ConvertTo-Json -Depth 16']) assert.ok(ui.includes(marker),'UI marker missing: '+marker);
