...
assert.ok(installer.includes('command -v setsid'));
assert.ok(installer.includes('setsid bash "$AGENT_DIR/agents/termux/start-agent.sh"'));
assert.ok(installer.includes('bash "$AGENT_DIR/agents/termux/start-agent.sh"'));
