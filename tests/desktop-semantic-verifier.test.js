...
assert.equal(verifyObservation(observed, { focused_title: 'PowerShell' }).ok, true);
...
assert.deepEqual(inferExpectation({ operation: 'computer.use', input: { action: 'open', target: 'PowerShell' } }), { focused_title: 'PowerShell' });
