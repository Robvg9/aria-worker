...
assert.deepStrictEqual(executors.map(e=>e.type),['connector','device','agent','model','eas','self_improvement']);
...
assert.deepStrictEqual(resolveExecutor({operation:'self.improve',executor_type:'self_improvement',target:{type:'self_improvement',engine_id:'self-improvement-engine-v1'}}),{executor_id:'self-improvement',type:'self_improvement',operation:'self.improve',target:{type:'self_improvement',engine_id:'self-improvement-engine-v1'}});
