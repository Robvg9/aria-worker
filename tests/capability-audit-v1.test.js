...
const CAPABILITIES = Object.freeze([
  ...
  { id: 'computer_use', modules: ['computer-use-runtime-v1'], tests: ['tests/computer-use-runtime-v1.test.js'] },
  { id: 'multi_agent', modules: ['agents/multi-agent-v2'], tests: ['tests/multi-agent-v2.test.js', 'tests/multi-agent-runtime-v2.test.js'] },
  { id: 'android_runtime', modules: ['device'], tests: ['tests/device-universe-v1.test.js', 'tests/live-device-client.test.js'] },
